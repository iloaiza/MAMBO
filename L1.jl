...
RUN(H, DO_CSA = DO_CSA, DO_DF = DO_DF, DO_ΔE = DO_ΔE, DO_AC = DO_AC, DO_OO = DO_OO, DO_SQRT = DO_SQRT, COUNT = COUNT, verbose=verbose)
...
if SYM_SHIFT
	...
	RUN(H_SYM, DO_CSA = DO_CSA, DO_DF = DO_DF, DO_ΔE = DO_ΔE, DO_AC = DO_AC, DO_OO = DO_OO, DO_SQRT = DO_SQRT, COUNT = COUNT, verbose=verbose)
end
...
if INT
	...
	RUN(H_INT, DO_CSA = DO_CSA, DO_DF = DO_DF, DO_ΔE = DO_ΔE, DO_AC = DO_AC, DO_OO = DO_OO, DO_SQRT = DO_SQRT, COUNT = COUNT, verbose=verbose)
end